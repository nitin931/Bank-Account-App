...
public class HDFCAccount implements BankAccountInterface{
    ...
    final String IFSCCode = "HDFC9318";
    ...
    public String addMoney(double amount) {
        this.balance += amount;
        return "Amount added Successfuly. New Balance is:"+ this.balance;
    }
    ...
    public String withdrawMoney(double amount, String password) {
        ...
        if(this.password.equals(password)){
            ...
            this.balance -= amount;
            return "Amount deducted Successfully. Total Balance:"+ this.balance;
        }
